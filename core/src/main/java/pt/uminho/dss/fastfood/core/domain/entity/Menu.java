...
public class Menu implements Item {
    ...
    public Menu(int id, String nome, String descricao, float precoBase, int tempoPreparacaoBase) {
        this.id = id;
        this.nome = nome;
    ...
    public Menu(String nome, String descricao, float precoBase, int tempoPreparacaoBase) {
