...
-- 5. Estacao_Trabalho (Especialidades para Cozinha)
CREATE TABLE Estacao_Trabalho (
estacao_id INTEGER NOT NULL,
trabalho VARCHAR(50) NOT NULL, -- Enum: GRELHA, FRITURA, MONTAGEM, etc.
...
id INTEGER PRIMARY KEY AUTO_INCREMENT,
nome VARCHAR(255) NOT NULL,
duracao_minutos BIGINT, -- Mapeia Duration em Java
trabalho VARCHAR(50) NOT NULL -- Enum: GRELHA, FRITURA, MONTAGEM, etc.
);
