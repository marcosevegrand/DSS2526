...
import pt.uminho.dss.restaurante.domain.entity.LinhaIngrediente;
import pt.uminho.dss.restaurante.domain.entity.PassoProducao;
        ...
        try (PreparedStatement ps = conn.prepareStatement(sqlIngs)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    if (alg != null)
                        i.setAlergenico(pt.uminho.dss.restaurante.domain.enumeration.Alergenico.valueOf(alg));
